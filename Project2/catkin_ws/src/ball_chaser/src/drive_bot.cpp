...
{
        //ROS_INFO("DriveToTargetRequest received - v_x:%1.2f, omega_z:%1.2f", (float)req.linear_x, (float)req.angular_z);
	...
	res.msg_feedback = "Motor command set - v_x: " +
	std::to_string(motor_command.linear.x) + " , omega_z: " +
